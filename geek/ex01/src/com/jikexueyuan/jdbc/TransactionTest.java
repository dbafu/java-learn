...
public class TransactionTest {
    ...
    public static void insertAddressData(Connection conn) throws Exception {
        String sql = "INSERT INTO tbl_address(id, city, country, user_id)" + "VALUES(1, 'Shanghaim', 'China', 10)";
        Statement st = conn.createStatement();
        int count = st.executeUpdate(sql);
